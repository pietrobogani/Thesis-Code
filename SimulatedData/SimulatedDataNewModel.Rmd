...
Yh_real <- stats::filter(y_real, rep(1/step, step), sides=1)
hist(na.omit(Yh), xlim = range(c(na.omit(Yh),na.omit(Yh_real))))
hist(na.omit(Yh_real), xlim = range(c(na.omit(Yh), na.omit(Yh_real))))
```
