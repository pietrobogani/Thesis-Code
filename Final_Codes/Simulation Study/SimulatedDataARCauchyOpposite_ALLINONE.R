#With this scripto, estimations of QR, QRF, CQR QR and CQR QRF can be computed by commenting/uncommenting
...
file_path <- "ALLINONE_Cauchy_Results_Forest_Opposite_TEST.xlsx"
#file_path <- "ALLINONE_Cauchy_Results_Opposite_TEST.xlsx"
...
#------------------- Generate n + n2 points for the AR(2) Cauchy-error model, this is our DGP
  ...
  Y_ar2 <- numeric(n+n2)
  Y_ar2[1:2] <- rnorm(2) #Initialise the series
  for (i in 3:(n+n2)) {
