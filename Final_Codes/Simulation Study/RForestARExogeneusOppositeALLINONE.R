...
file_path <- "ALLINONE_Exogenous_Results_Opposite_RForest_TEST.xlsx"
...
ggsave(filename = paste0("Exogeneus_calibration_n", n - 3,"_", p_n, "QRF_AR(2).pdf"), plot = p, width = 7, height = 5)
}
